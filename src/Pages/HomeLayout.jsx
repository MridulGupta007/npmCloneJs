  ...
  return (
    <div className="bg-gradient-to-br from-[#e20074] via-[#e94057] to-[#f27121] text-white flex flex-col gap-y-8 pt-20">
      ...
      <div className="font-poppins font-bold text-[16px] self-center flex flex-col md:flex-row gap-x-10 py-10">
        ...
        <button className="border-2 border-white rounded-full py-4 px-12 bg-[#cb3837]">
          Learn about Pro
        </button>
      </div>
    </div>
...
const HeroSection_two = () => {
  return (
    <div className="flex flex-col pt-16 pb-40 gap-y-8">
      ...
      <h1 className="self-center font-poppins text-[36px] font-semibold w-1/3 text-center">
        Bring the best of open source to you, your team, and your company
      </h1>
      <p className="self-center font-arimo text-[16px] w-1/3 text-center">
